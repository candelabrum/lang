SRCMODULES = str.cpp edges.cpp lex.cpp sa.cpp rpn.cpp l.cpp rpn_func.cpp rpn_types.cpp rpn_list.cpp rpn_go.cpp main.cpp exe.cpp rpn_far.cpp rpn_fcmp.cpp rpn_fbl.cpp
